...
(function() {
    ...
    function setup() {
      ...
      //confused - I should be able to create a function that chooses a different currentword based on the selected category - Kaia suggests not calling functions within functions but i feel like that could work
    ...
    //       currentWord = randomAnimals[Math.floor(Math.random() * randomAnimals.length)];}
    //   else {
    //       currentWord = randomFruites[Math.floor(Math.random() * randomFruits.length)];}
